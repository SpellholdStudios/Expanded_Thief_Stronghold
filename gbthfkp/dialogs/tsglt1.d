...
IF ~Global("PGFailed","GLOBAL",1)~ THEN BEGIN 1
  ...
  IF ~~ THEN DO ~EraseJournalEntry(55542)~ JOURNAL #55538 /* ~Thieves' Guild Stronghold: the guild has failed.
...
SetGlobal("PGThievesLeave","GLOBAL",1)~ EXIT
END
...
IF ~~ THEN BEGIN 15
  ...
  IF ~GlobalLT("HanzThief","GLOBAL",5) !Dead("Hanz")~ THEN REPLY #32317 /* ~Hanz, eh? What is he currently up to?~ */ GOTO 16
  IF ~Global("HanzThief","GLOBAL",5) !Dead("Hanz")~ THEN REPLY #32317 /* ~Hanz, eh? What is he currently up to?~ */ GOTO 28
  IF ~Dead("Hanz")~ THEN REPLY #32317 /* ~Hanz, eh? What is he currently up to?~ */ GOTO 29
...
IF ~~ THEN BEGIN 16
  ...
  IF ~~ THEN REPLY #32439 /* ~I don't want him to do anything for the next few days.~ */ DO ~SetGlobal("HanzThief","GLOBAL",0)~ GOTO 41
END
...
IF ~~ THEN BEGIN 24
  ...
  IF ~RandomNumLT(100,36)~ THEN GOTO 39
  IF ~RandomNumGT(100,35)~ THEN GOTO 40
END

IF ~~ THEN BEGIN 25
  SAY #32391 /* ~I will inform Hanz of your instructions immediately.~ */
  IF ~RandomNumLT(100,21)~ THEN GOTO 37
  IF ~RandomNumGT(100,20)~ THEN GOTO 38
END

IF ~~ THEN BEGIN 26
  SAY #32391 /* ~I will inform Hanz of your instructions immediately.~ */
  IF ~RandomNumLT(100,51)~ THEN GOTO 35
  IF ~RandomNumGT(100,50)~ THEN GOTO 36
END

IF ~~ THEN BEGIN 27
  SAY #32391 /* ~I will inform Hanz of your instructions immediately.~ */
  IF ~RandomNumLT(100,11)~ THEN GOTO 33
  IF ~RandomNumGT(100,10)~ THEN GOTO 34
END
...
IF ~~ THEN BEGIN 28
  ...
  IF ~PartyGoldGT(999)~ THEN REPLY #32411 /* ~I will pay it. No rogue of mine will languish in jail.~ */ DO ~TakePartyGold(1000)~ GOTO 30
...
IF ~~ THEN BEGIN 30
  ...
  IF ~~ THEN REPLY #32413 /* ~Yes, I will give him his duties now.~ */ DO ~SetGlobal("HanzRescue","GLOBAL",1)~ GOTO 17
  IF ~~ THEN REPLY #32414 /* ~No, leave him to rest this week.~ */ DO ~SetGlobal("HanzThief","GLOBAL",0) SetGlobal("HanzRescue","GLOBAL",1)~ GOTO 41
END
...
IF ~~ THEN BEGIN 33
  ...
  IF ~~ THEN DO ~SetGlobal("HanzThief","GLOBAL",1) SetGlobal("HanzAssigned","GLOBAL",1)~ GOTO 41
END
...
IF ~~ THEN BEGIN 35
  ...
  IF ~~ THEN DO ~SetGlobal("HanzThief","GLOBAL",4) SetGlobal("HanzAssigned","GLOBAL",1)~ GOTO 41
END
...
IF ~~ THEN BEGIN 37
  ...
  IF ~~ THEN DO ~SetGlobal("HanzThief","GLOBAL",2) SetGlobal("HanzAssigned","GLOBAL",1)~ GOTO 41
END
...
IF ~~ THEN BEGIN 39
  ...
  IF ~~ THEN DO ~SetGlobal("HanzThief","GLOBAL",3) SetGlobal("HanzAssigned","GLOBAL",1)~ GOTO 41
END
...
IF ~~ THEN BEGIN 41
  ...
  IF ~GlobalLT("MilphThief","GLOBAL",5) !Dead("Milph")~ THEN REPLY #32432 /* ~What is Goshan's current status?~ */ GOTO 42
  IF ~Global("MilphThief","GLOBAL",5) !Dead("Milph")~ THEN REPLY #32432 /* ~What is Goshan's current status?~ */ GOTO 54
  IF ~Dead("Milph")~ THEN REPLY #32432 /* ~What is Goshan's current status?~ */ GOTO 55
...
IF ~~ THEN BEGIN 42
  ...
  IF ~~ THEN REPLY #32439 /* ~I don't want him to do anything for the next few days.~ */ DO ~SetGlobal("MilphThief","GLOBAL",0)~ GOTO 67
END
...
IF ~~ THEN BEGIN 50
  ...
  IF ~RandomNumLT(100,36)~ THEN GOTO 65
  IF ~RandomNumGT(100,35)~ THEN GOTO 66
END

IF ~~ THEN BEGIN 51
  SAY #32464 /* ~Very well. I will inform Goshan of your instructions. ~ */
  IF ~RandomNumLT(100,21)~ THEN GOTO 63
  IF ~RandomNumGT(100,20)~ THEN GOTO 64
END

IF ~~ THEN BEGIN 52
  SAY #32464 /* ~Very well. I will inform Goshan of your instructions. ~ */
  IF ~RandomNumLT(100,51)~ THEN GOTO 61
  IF ~RandomNumGT(100,50)~ THEN GOTO 62
END

IF ~~ THEN BEGIN 53
  SAY #32464 /* ~Very well. I will inform Goshan of your instructions. ~ */
  IF ~RandomNumLT(100,11)~ THEN GOTO 59
  IF ~RandomNumGT(100,10)~ THEN GOTO 60
END
...
IF ~~ THEN BEGIN 54
  ...
  IF ~PartyGoldGT(1999)~ THEN REPLY #32469 /* ~Consider it paid. He is a valuable member of the guild.~ */ DO ~TakePartyGold(2000)~ GOTO 56
...
IF ~~ THEN BEGIN 56
  ...
  IF ~~ THEN REPLY #32471 /* ~Yes, he should be put straight back to work.~ */ DO ~SetGlobal("MilphRescue","GLOBAL",1)~ GOTO 43
  IF ~~ THEN REPLY #32472 /* ~No, he can rest for a few days. ~ */ DO ~SetGlobal("MilphThief","GLOBAL",0) SetGlobal("MilphRescue","GLOBAL",1)~ GOTO 67
END
...
IF ~~ THEN BEGIN 59
  ...
  IF ~~ THEN DO ~SetGlobal("MilphThief","GLOBAL",1) SetGlobal("MilphAssigned","GLOBAL",1)~ GOTO 67
END
...
IF ~~ THEN BEGIN 61
  ...
  IF ~~ THEN DO ~SetGlobal("MilphThief","GLOBAL",4) SetGlobal("MilphAssigned","GLOBAL",1)~ GOTO 67
END
...
IF ~~ THEN BEGIN 63
  ...
  IF ~~ THEN DO ~SetGlobal("MilphThief","GLOBAL",2) SetGlobal("MilphAssigned","GLOBAL",1)~ GOTO 67
END
...
IF ~~ THEN BEGIN 65
  ...
  IF ~~ THEN DO ~SetGlobal("MilphThief","GLOBAL",3) SetGlobal("MilphAssigned","GLOBAL",1)~ GOTO 67
END
...
IF ~~ THEN BEGIN 67
  ...
  IF ~GlobalLT("KretorThief","GLOBAL",5)!Dead("Kretor")
~ THEN REPLY #34786 /* ~And this Kretor is ready to accept my commands?~ */ GOTO 68
  IF ~Global("KretorThief","GLOBAL",5) !Dead("Kretor")~ THEN REPLY #34786 /* ~And this Kretor is ready to accept my commands?~ */ GOTO 80
  IF ~Dead("Kretor")~ THEN REPLY #34786 /* ~And this Kretor is ready to accept my commands?~ */ GOTO 81
  IF ~~ THEN REPLY #32487 /* ~Everyone else is fine the way they currently are.~ */ GOTO 14
  IF ~Global("KretorThief","GLOBAL",9) !Dead("Kretor")~ THEN REPLY #34786 /* ~And this Kretor is ready to accept my commands?~ */ GOTO 197
END
...
IF ~~ THEN BEGIN 68
  ...
  IF ~~ THEN REPLY #32495 /* ~I want him to do nothing. I want none of his cutpurses on the street.~ */ DO ~SetGlobal("KretorThief","GLOBAL",0)~ GOTO 93
END
...
IF ~~ THEN BEGIN 76
  ...
  IF ~RandomNumLT(100,36)~ THEN GOTO 91
  IF ~RandomNumGT(100,35)~ THEN GOTO 92
END

IF ~~ THEN BEGIN 77
  SAY #32516 /* ~I will tell Kretor of all you have decided.~ */
  IF ~RandomNumLT(100,21)~ THEN GOTO 89
  IF ~RandomNumGT(100,20)~ THEN GOTO 90
END

IF ~~ THEN BEGIN 78
  SAY #32516 /* ~I will tell Kretor of all you have decided.~ */
  IF ~RandomNumLT(100,51)~ THEN GOTO 87
  IF ~RandomNumGT(100,50)~ THEN GOTO 88
END

IF ~~ THEN BEGIN 79
  SAY #32516 /* ~I will tell Kretor of all you have decided.~ */
  IF ~RandomNumLT(100,11)~ THEN GOTO 85
  IF ~RandomNumGT(100,10)~ THEN GOTO 86
END
...
IF ~~ THEN BEGIN 80
  ...
  IF ~PartyGoldGT(499)
~ THEN REPLY #32521 /* ~I will pay. His business is humble, but it is valuable to the guild.~ */ DO ~TakePartyGold(500)~ GOTO 82
...
IF ~~ THEN BEGIN 82
  ...
  IF ~~ THEN REPLY #32523 /* ~I will assign them now. He will have to earn back his ransom.~ */ DO ~SetGlobal("KretorRescue","GLOBAL",1)~ GOTO 69
  IF ~~ THEN REPLY #32524 /* ~No, I will give him time to rest for now.~ */ DO ~SetGlobal("KretorThief","GLOBAL",0)
SetGlobal("KretorRescue","GLOBAL",1)~ GOTO 93
END
...
IF ~~ THEN BEGIN 85
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",1) SetGlobal("KretorAssigned","GLOBAL",1)~ GOTO 93
END
...
IF ~~ THEN BEGIN 87
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",4) SetGlobal("KretorAssigned","GLOBAL",1)~ GOTO 93
END
...
IF ~~ THEN BEGIN 89
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",2) SetGlobal("KretorAssigned","GLOBAL",1)~ GOTO 93
END
...
IF ~~ THEN BEGIN 91
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",3) SetGlobal("KretorAssigned","GLOBAL",1)~ GOTO 93
END
...
IF ~~ THEN BEGIN 93
  ...
  IF ~GlobalLT("MorsaThief","GLOBAL",5) !Dead("Morsa")~ THEN REPLY #32537 /* ~A smuggler, eh? Is she currently active?~ */ GOTO 94
  IF ~Global("MorsaThief","GLOBAL",5) !Dead("Morsa")~ THEN REPLY #32537 /* ~A smuggler, eh? Is she currently active?~ */ GOTO 106
  IF ~Dead("Morsa")~ THEN REPLY #32537 /* ~A smuggler, eh? Is she currently active?~ */ GOTO 107
...
IF ~~ THEN BEGIN 94
  ...
  IF ~~ THEN REPLY #32543 /* ~I want her to stop. I want no smuggled goods brought into the city.~ */ DO ~SetGlobal("MorsaThief","GLOBAL",0)~ GOTO 119
END
...
IF ~~ THEN BEGIN 98
  ...
  IF ~~ THEN REPLY #32557 /* ~She would just be the transport, so I see no harm.~ */ DO ~ReputationInc(-1) SetGlobal("TSPCIsSlaver","GLOBAL",1)~ GOTO 102
  IF ~~ THEN REPLY #32558 /* ~Absolutely not. I won't have it.~ */ DO ~SetGlobal("TSPCIsSlaver","GLOBAL",0)~ GOTO 103
END
...
IF ~~ THEN BEGIN 99
  ...
  IF ~~ THEN REPLY #32559 /* ~The gold will ease any pangs of guilt I feel. Have her do it.~ */ DO ~ReputationInc(-1) SetGlobal("TSPCIsSlaver","GLOBAL",1)~ GOTO 104
  IF ~~ THEN REPLY #32560 /* ~I will have no such thing in my guild.~ */ DO ~SetGlobal("TSPCIsSlaver","GLOBAL",0)~ GOTO 102
END
...
IF ~~ THEN BEGIN 100
  ...
  IF ~~ THEN REPLY #32561 /* ~By all means. She will just be a gobetween, so I see nothing wrong.~ */ DO ~ReputationInc(-1) SetGlobal("TSPCIsSlaver","GLOBAL",1)~ GOTO 103
  IF ~~ THEN REPLY #32562 /* ~I will not have such a thing in my guild. I forbid it.~ */ DO ~SetGlobal("TSPCIsSlaver","GLOBAL",0)~ GOTO 105
END
...
IF ~~ THEN BEGIN 101
  ...
  IF ~~ THEN REPLY #32563 /* ~Certainly. If not us, then someone else. We might as well profit.~ */ DO ~ReputationInc(-1) SetGlobal("TSPCIsSlaver","GLOBAL",1)~ GOTO 102
  IF ~~ THEN REPLY #32564 /* ~No, I will not allow it. I will not have the guild associated with slave trading.~ */ DO ~SetGlobal("TSPCIsSlaver","GLOBAL",0)~ GOTO 103
END

IF ~~ THEN BEGIN 102
  SAY #32568 /* ~I will inform Morsa of your decisions. ~ */
  IF ~RandomNumLT(100,36)~ THEN GOTO 117
  IF ~RandomNumGT(100,35)~ THEN GOTO 118
END

IF ~~ THEN BEGIN 103
  SAY #32568 /* ~I will inform Morsa of your decisions. ~ */
  IF ~RandomNumLT(100,21)~ THEN GOTO 115
  IF ~RandomNumGT(100,20)~ THEN GOTO 116
END

IF ~~ THEN BEGIN 104
  SAY #32568 /* ~I will inform Morsa of your decisions. ~ */
  IF ~RandomNumLT(100,51)~ THEN GOTO 113
  IF ~RandomNumGT(100,50)~ THEN GOTO 114
END

IF ~~ THEN BEGIN 105
  SAY #32568 /* ~I will inform Morsa of your decisions. ~ */
  IF ~RandomNumLT(100,11)~ THEN GOTO 111
  IF ~RandomNumGT(100,10)~ THEN GOTO 112
END
...
IF ~~ THEN BEGIN 106
  ...
  IF ~PartyGoldGT(2499)~ THEN REPLY #32575 /* ~I will pay. She will be free as soon as possible.~ */ DO ~TakePartyGold(2500)~ GOTO 108
...
IF ~~ THEN BEGIN 108
  ...
  IF ~~ THEN REPLY #32573 /* ~Yes, I must recoup these losses quickly.~ */ DO ~SetGlobal("MorsaRescue","GLOBAL",1)~ GOTO 95
  IF ~~ THEN REPLY #32574 /* ~No, let her rest a while.~ */ DO ~SetGlobal("MorsaThief","GLOBAL",0) SetGlobal("MorsaRescue","GLOBAL",1)~ GOTO 119
END
...
IF ~~ THEN BEGIN 111
  ...
  IF ~~ THEN DO ~SetGlobal("MorsaThief","GLOBAL",1) SetGlobal("MorsaAssigned","GLOBAL",1)~ GOTO 119
END
...
IF ~~ THEN BEGIN 113
  ...
  IF ~~ THEN DO ~SetGlobal("MorsaThief","GLOBAL",4) SetGlobal("MorsaAssigned","GLOBAL",1)~ GOTO 119
END
...
IF ~~ THEN BEGIN 115
  ...
  IF ~~ THEN DO ~SetGlobal("MorsaThief","GLOBAL",3) SetGlobal("MorsaAssigned","GLOBAL",1)~ GOTO 119
END

IF ~~ THEN BEGIN 116
  SAY #32583 /* ~The conditions you have set should be fairly reasonable to achieve. Everything should be fine, though who can be sure?~ */
  IF ~~ THEN DO ~SetGlobal("MorsaThief","GLOBAL",2) SetGlobal("MorsaAssigned","GLOBAL",1)~ GOTO 119
END
...
IF ~~ THEN BEGIN 119
  SAY #32586 /* ~You have one more rogue.  Varia's preferred activity is providing 'protection,' and keeping embarrassing facts about powerful people  safe... for a fee.~ */
  IF ~GlobalLT("VariaThief","GLOBAL",5) !Dead("Varia")~ THEN REPLY #32593 /* ~Protection rackets and blackmail, eh? Is she ready for orders?~ */ GOTO 120
  IF ~Global("VariaThief","GLOBAL",5) !Dead("Varia")~ THEN REPLY #32593 /* ~Protection rackets and blackmail, eh? Is she ready for orders?~ */ GOTO 132
  IF ~Dead("Varia")~ THEN REPLY #32593 /* ~Protection rackets and blackmail, eh? Is she ready for orders?~ */ GOTO 133
...
IF ~~ THEN BEGIN 120
  ...
  IF ~~ THEN REPLY #32602 /* ~Then have her cease all activities for the next little while.~ */ DO ~SetGlobal("VariaThief","GLOBAL",0)~ GOTO 14
END
...
IF ~~ THEN BEGIN 128
  ...
  IF ~RandomNumLT(100,36)~ THEN GOTO 143
  IF ~RandomNumGT(100,35)~ THEN GOTO 144
END

IF ~~ THEN BEGIN 129
  SAY #32646 /* ~I will inform Varia of your directions. ~ */
  IF ~RandomNumLT(100,21)~ THEN GOTO 141
  IF ~RandomNumGT(100,20)~ THEN GOTO 142
END

IF ~~ THEN BEGIN 130
  SAY #32646 /* ~I will inform Varia of your directions. ~ */
  IF ~RandomNumLT(100,51)~ THEN GOTO 139
  IF ~RandomNumGT(100,50)~ THEN GOTO 140
END

IF ~~ THEN BEGIN 131
  SAY #32646 /* ~I will inform Varia of your directions. ~ */
  IF ~RandomNumLT(100,11)~ THEN GOTO 137
  IF ~RandomNumGT(100,10)~ THEN GOTO 138
END
...
IF ~~ THEN BEGIN 132
  ...
  IF ~PartyGoldGT(2999)~ THEN REPLY #32655 /* ~I will pay. I wouldn't want her on my bad side.~ */ DO ~TakePartyGold(3000)~ GOTO 134
...
IF ~~ THEN BEGIN 134
  ...
  IF ~~ THEN REPLY #32659 /* ~Yes, she needs to earn back this bribe money.~ */ DO ~SetGlobal("VariaRescue","GLOBAL",1)~ GOTO 121
  IF ~~ THEN REPLY #32660 /* ~No, she may rest for now.~ */ DO ~SetGlobal("VariaThief","GLOBAL",0)
SetGlobal("VariaRescue","GLOBAL",1)~ GOTO 14
END
...
IF ~~ THEN BEGIN 137
  ...
  IF ~~ THEN DO ~SetGlobal("VariaThief","GLOBAL",1) SetGlobal("VariaAssigned","GLOBAL",1)~ GOTO 14
END
...
IF ~~ THEN BEGIN 139
  ...
  IF ~~ THEN DO ~SetGlobal("VariaThief","GLOBAL",4) SetGlobal("VariaAssigned","GLOBAL",1)~ GOTO 14
END
...
IF ~~ THEN BEGIN 141
  ...
  IF ~~ THEN DO ~SetGlobal("VariaThief","GLOBAL",2) SetGlobal("VariaAssigned","GLOBAL",1)~ GOTO 14
END
...
circumstance for her to overcome. I'm sure she'll be up to the task though. ~ */
  IF ~~ THEN DO ~SetGlobal("VariaThief","GLOBAL",3) SetGlobal("VariaAssigned","GLOBAL",1)~ GOTO 14
END
...
~ THEN BEGIN 145
  ...
  IF ~Global("HanzThief","GLOBAL",1) !Dead("Hanz")~ THEN GOTO 146
  IF ~Global("HanzThief","GLOBAL",2) !Dead("Hanz")~ THEN GOTO 147
  IF ~Global("HanzThief","GLOBAL",3) !Dead("Hanz")~ THEN GOTO 148
  IF ~Global("HanzThief","GLOBAL",4) !Dead("Hanz")~ THEN GOTO 149
  IF ~Global("HanzThief","GLOBAL",5) !Dead("Hanz")~ THEN GOTO 150
  IF ~Dead("Hanz")~ THEN GOTO 153
  IF ~Global("HanzThief","GLOBAL",0) !Dead("Hanz")~ THEN GOTO 154
END

IF ~~ THEN BEGIN 146
  SAY #32692 /* ~Hanz did reasonably well. He did not have much of a challenge, but a meager profit is ample reward for low risk.~ */
  IF ~~ THEN DO ~GiveGoldForce(200)~ GOTO 155
END
...
IF ~~ THEN BEGIN 149
  ...
  IF ~~ THEN DO ~GiveGoldForce(900)~ GOTO 155
END

IF ~~ THEN BEGIN 150
  SAY @58 /* ~Unfortunately, Hanz is currently in the hands of the guards. Will you authorize his release? We can bribe the city officials if you put up the 1000 gold.~ */
  IF ~PartyGoldGT(999) ~ THEN REPLY #32702 /* ~Yes, I will not have him stuck behind bars.~ */ DO ~TakePartyGold(1000)~ GOTO 151
...
IF ~~ THEN BEGIN 151
  ...
  IF ~~ THEN DO ~SetGlobal("HanzThief","GLOBAL",0) SetGlobal("HanzRescue","GLOBAL",1)~ GOTO 155
END
...
IF ~~ THEN BEGIN 155
  ...
  IF ~Global("MilphThief","GLOBAL",1) !Dead("Milph")~ THEN GOTO 156
  IF ~Global("MilphThief","GLOBAL",2) !Dead("Milph")~ THEN GOTO 157
  IF ~Global("MilphThief","GLOBAL",3) !Dead("Milph")~ THEN GOTO 158
  IF ~Global("MilphThief","GLOBAL",4) !Dead("Milph")~ THEN GOTO 159
  IF ~Global("MilphThief","GLOBAL",5) !Dead("Milph")~ THEN GOTO 160
  IF ~Dead("Milph")~ THEN GOTO 163
  IF ~Global("MilphThief","GLOBAL",0) !Dead("Milph")~ THEN GOTO 164
END
...
IF ~~ THEN BEGIN 156
  ...
  IF ~~ THEN DO ~GiveGoldForce(200)~ GOTO 165
END
...
IF ~~ THEN BEGIN 159
  ...
  IF ~~ THEN DO ~GiveGoldForce(750)~ GOTO 165
END

IF ~~ THEN BEGIN 160 // from: 155.4
  SAY @110 /* ~Goshan is in the custody of the city guards at the moment. We can bribe the guards if you will put up the 2000 gold it will cost.~ */
  IF ~PartyGoldGT(1999)~ THEN REPLY #32727 /* ~Certainly. I would not wish him to be left behind bars for long.~ */ DO ~TakePartyGold(2000)~ GOTO 161
...
IF ~~ THEN BEGIN 161
  SAY #32744 /* ~Very well, I will have him released as soon as possible. You will have to reassign him his tasks when I am done reporting on the others. ~ */
  IF ~~ THEN DO ~SetGlobal("MilphThief","GLOBAL",0) SetGlobal("MilphRescue","GLOBAL",1)~ GOTO 165
END
...
IF ~~ THEN BEGIN 165
  ...
  IF ~Global("KretorThief","GLOBAL",1) !Dead("Kretor")~ THEN GOTO 166
  IF ~Global("KretorThief","GLOBAL",2) !Dead("Kretor")~ THEN GOTO 167
  IF ~Global("KretorThief","GLOBAL",3) !Dead("Kretor")~ THEN GOTO 168
  IF ~Global("KretorThief","GLOBAL",4) !Dead("Kretor")~ THEN GOTO 169
  IF ~Global("KretorThief","GLOBAL",5) !Dead("Kretor")~ THEN GOTO 170
  IF ~Dead("Kretor")~ THEN GOTO 173
  IF ~Global("KretorThief","GLOBAL",0) !Dead("Kretor")~ THEN GOTO 174
  IF ~Global("KretorThief","GLOBAL",9) !Dead("Kretor")~ THEN GOTO 199
END
...
IF ~~ THEN BEGIN 166
  ...
  IF ~~ THEN DO ~GiveGoldForce(250)~ GOTO 175
END
...
IF ~~ THEN BEGIN 167
  ...
  IF ~~ THEN DO ~GiveGoldForce(500)~ GOTO 175
END
...
IF ~~ THEN BEGIN 168
  ...
  IF ~~ THEN DO ~GiveGoldForce(750)~ GOTO 175
END
...
IF ~~ THEN BEGIN 169
  ...
  IF ~~ THEN DO ~GiveGoldForce(1000)~ GOTO 175
END

IF ~~ THEN BEGIN 170
  SAY @163 /* ~Kretor has been arrested and is being held out of our reach. It will cost 500 gold to have him released. This is a reasonable bribe. Will you pay the gold?~ */
  IF ~PartyGoldGT(499)~ THEN REPLY #32758 /* ~Yes, I will. He is of no use behind bars.~ */ DO ~TakePartyGold(500)~ GOTO 171
...
IF ~~ THEN BEGIN 171
  SAY #32744 /* ~Very well, I will have him released as soon as possible. You will have to reassign him his tasks when I am done reporting on the others. ~ */
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",0) SetGlobal("KretorRescue","GLOBAL",1)~ GOTO 175
END
...
IF ~~ THEN BEGIN 175
  ...
  IF ~Global("MorsaThief","GLOBAL",1) !Dead("Morsa")~ THEN GOTO 176
  IF ~Global("MorsaThief","GLOBAL",2) !Dead("Morsa")~ THEN GOTO 177
  IF ~Global("MorsaThief","GLOBAL",3) !Dead("Morsa")~ THEN GOTO 178
  IF ~Global("MorsaThief","GLOBAL",4) !Dead("Morsa")~ THEN GOTO 179
  IF ~Global("MorsaThief","GLOBAL",5) !Dead("Morsa")~ THEN GOTO 180
  IF ~Dead("Morsa")~ THEN GOTO 183
  IF ~Global("MorsaThief","GLOBAL",0) !Dead("Morsa")~ THEN GOTO 184
END
...
IF ~~ THEN BEGIN 176
  ...
  IF ~~ THEN DO ~GiveGoldForce(100)~ GOTO 185
END
...
IF ~~ THEN BEGIN 177
  ...
  IF ~~ THEN DO ~GiveGoldForce(250)~ GOTO 185
END
...
IF ~~ THEN BEGIN 178
  ...
  IF ~~ THEN DO ~GiveGoldForce(500)~ GOTO 185
END
...
IF ~~ THEN BEGIN 179
  ...
  IF ~~ THEN DO ~GiveGoldForce(750)~ GOTO 185
END

IF ~~ THEN BEGIN 180
  SAY @215 /* ~Morsa is in the hands of the guards. Smugglers are not well liked, and it will cost 2500 gold to bribe her out. Do you have the coin to pay?~ */
  IF ~PartyGoldGT(2499) ~ THEN REPLY #32775 /* ~Yes, get her back in my service as soon as possible.~ */ DO ~TakePartyGold(2500)~ GOTO 181
...
IF ~~ THEN BEGIN 181
  ...
  IF ~~ THEN DO ~SetGlobal("MorsaThief","GLOBAL",0) SetGlobal("MorsaRescue","GLOBAL",1)~ GOTO 185
END
...
IF ~~ THEN BEGIN 185
  ...
  IF ~Global("VariaThief","GLOBAL",1) !Dead("Varia")~ THEN GOTO 186
  IF ~Global("VariaThief","GLOBAL",2) !Dead("Varia")~ THEN GOTO 187
  IF ~Global("VariaThief","GLOBAL",3) !Dead("Varia")~ THEN GOTO 188
  IF ~Global("VariaThief","GLOBAL",4) !Dead("Varia")~ THEN GOTO 189
  IF ~Global("VariaThief","GLOBAL",5) !Dead("Varia")~ THEN GOTO 190
  IF ~Dead("Varia")~ THEN GOTO 193 
  IF ~Global("VariaThief","GLOBAL",0) !Dead("Varia")~ THEN GOTO 194
END
...
IF ~~ THEN BEGIN 186
  ...
  IF ~~ THEN DO ~GiveGoldForce(150)~ GOTO 195
END
...
IF ~~ THEN BEGIN 187
  ...
  IF ~~ THEN DO ~GiveGoldForce(300)~ GOTO 195
END

IF ~~ THEN BEGIN 188
  SAY #32779 /* ~She has done well, and returned with a nice profit. The risk was worth it, I suppose. Well instructed.~ */
  IF ~~ THEN DO ~GiveGoldForce(500)~ GOTO 195
END

IF ~~ THEN BEGIN 189
  SAY #32780 /* ~She is well worth her pay today. The risk was astounding, but she was returned with nary a scratch on her.~ */
  IF ~~ THEN DO ~GiveGoldForce(800)~ GOTO 195
END

IF ~~ THEN BEGIN 190
  SAY @267 /* ~Varia is incarcerated. Seems she angered the wrong member of government. I estimate it will require a 3000 gold bribe to free her. Will you pay it?~ */
  IF ~PartyGoldGT(2999) ~ THEN REPLY #32789 /* ~I will pay it. She is a valuable member of the guild.~ */ DO ~TakePartyGold(3000)~ GOTO 191
...
IF ~~ THEN BEGIN 191
  ...
  IF ~~ THEN DO ~SetGlobal("VariaThief","GLOBAL",0) SetGlobal("VariaRescue","GLOBAL",1)~ GOTO 195
END
