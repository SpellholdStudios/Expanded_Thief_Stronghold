...
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 1
  ...
  IF ~~ THEN DO ~SetGlobal("TalkedToKretor","AR0322",1)~ GOTO 2
END
...
IF ~~ THEN BEGIN 2
  ...
  IF ~Global("KretorThief","GLOBAL",1) Global("KretorRescue","GLOBAL",0) Global("KretorPay","GLOBAL",0)~ THEN GOTO 4
  IF ~Global("KretorThief","GLOBAL",2) Global("KretorRescue","GLOBAL",0) Global("KretorPay","GLOBAL",0)~ THEN GOTO 5
  IF ~Global("KretorThief","GLOBAL",3) Global("KretorRescue","GLOBAL",0) Global("KretorPay","GLOBAL",0)~ THEN GOTO 6
  IF ~Global("KretorThief","GLOBAL",4) Global("KretorRescue","GLOBAL",0) Global("KretorPay","GLOBAL",0)~ THEN GOTO 7
  IF ~Global("KretorThief","GLOBAL",0) Global("KretorRescue","GLOBAL",0) Global("KretorPay","GLOBAL",0)~ THEN GOTO 8
  IF ~Global("KretorRescue","GLOBAL",1) Global("KretorPay","GLOBAL",0)~ THEN GOTO 9
  IF ~Global("KretorPay","GLOBAL",1)~ THEN GOTO 16
  IF ~Global("KretorPay","GLOBAL",2) GlobalGT("LathanPlot","GLOBAL",7)~ THEN GOTO 17
  IF ~Global("KretorPay","GLOBAL",2) Global("LathanPlot","GLOBAL",7)~ THEN GOTO 3
END
...
IF ~~ THEN BEGIN 9
  ...
  IF ~~ THEN DO ~SetGlobal("KretorRescue","GLOBAL",0)~ GOTO 13
END

IF ~!AreaCheck("AR1005")
InPartySlot(LastTalkedToBy,0)
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 10
...
IF ~~ THEN BEGIN 16
  ...
  IF ~~ THEN DO ~SetGlobal("KretorPay","GLOBAL",0)~ GOTO 13
END
