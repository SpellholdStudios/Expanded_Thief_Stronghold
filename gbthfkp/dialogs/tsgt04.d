...
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 1
  ...
  IF ~~ THEN DO ~SetGlobal("TalkedToMorsa","AR0322",1)~ EXIT
END
...
IF ~~ THEN BEGIN 2 // from: 9.0
  ...
  IF ~Global("MorsaThief","GLOBAL",1) Global("MorsaRescue","GLOBAL",0)~ THEN GOTO 3
  IF ~Global("MorsaThief","GLOBAL",2) Global("MorsaRescue","GLOBAL",0)~ THEN GOTO 4
  IF ~Global("MorsaThief","GLOBAL",3) Global("MorsaRescue","GLOBAL",0)~ THEN GOTO 5
  IF ~Global("MorsaThief","GLOBAL",4) Global("MorsaRescue","GLOBAL",0)~ THEN GOTO 6
  IF ~Global("MorsaThief","GLOBAL",0) Global("MorsaRescue","GLOBAL",0)~ THEN GOTO 7
  IF ~Global("MorsaRescue","GLOBAL",1)~ THEN GOTO 8
END
...
IF ~~ THEN BEGIN 8
  ...
  IF ~~ THEN DO ~SetGlobal("MorsaRescue","GLOBAL",0)~ GOTO 12
END
