...
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 1
  ...
  IF ~Global("HanzThief","GLOBAL",1) Global("HanzRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToHanz","AR0322",1)~ GOTO 2
  IF ~Global("HanzThief","GLOBAL",2) Global("HanzRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToHanz","AR0322",1)~ GOTO 3
  IF ~Global("HanzThief","GLOBAL",3) Global("HanzRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToHanz","AR0322",1)~ GOTO 4
  IF ~Global("HanzThief","GLOBAL",4) Global("HanzRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToHanz","AR0322",1)~ GOTO 5
  IF ~Global("HanzThief","GLOBAL",0) Global("HanzRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToHanz","AR0322",1)~ GOTO 6
  IF ~Global("HanzRescue","GLOBAL",1)~ THEN DO ~SetGlobal("TalkedToHanz","AR0322",1)~ GOTO 7
END
...
IF ~~ THEN BEGIN 7
  ...
  IF ~~ THEN DO ~SetGlobal("HanzRescue","GLOBAL",0)~ GOTO 15
END
...
IF ~~ THEN BEGIN 9
  ...
  IF ~Global("HanzThief","GLOBAL",1) Global("HanzRescue","GLOBAL",0)~ THEN GOTO 2
  IF ~Global("HanzThief","GLOBAL",2) Global("HanzRescue","GLOBAL",0)~ THEN GOTO 3
  IF ~Global("HanzThief","GLOBAL",3) Global("HanzRescue","GLOBAL",0)~ THEN GOTO 4
  IF ~Global("HanzThief","GLOBAL",4) Global("HanzRescue","GLOBAL",0)~ THEN GOTO 5
  IF ~Global("HanzThief","GLOBAL",0) Global("HanzRescue","GLOBAL",0)~ THEN GOTO 6
  IF ~Global("HanzRescue","GLOBAL",1)~ THEN GOTO 7
END
...
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 16
