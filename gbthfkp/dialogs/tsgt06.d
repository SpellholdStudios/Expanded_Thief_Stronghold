...
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 1
  ...
  IF ~~ THEN DO ~SetGlobal("TalkedToVaria","AR0322",1)~ GOTO 2
END
...
IF ~~ THEN BEGIN 2
  ...
  IF ~Global("VariaThief","GLOBAL",1) Global("VariaRescue","GLOBAL",0)~ THEN GOTO 3
  IF ~Global("VariaThief","GLOBAL",2) Global("VariaRescue","GLOBAL",0)~ THEN GOTO 4
  IF ~Global("VariaThief","GLOBAL",3) Global("VariaRescue","GLOBAL",0)~ THEN GOTO 5
  IF ~Global("VariaThief","GLOBAL",4) Global("VariaRescue","GLOBAL",0)~ THEN GOTO 6
  IF ~Global("VariaThief","GLOBAL",0) Global("VariaRescue","GLOBAL",0)~ THEN GOTO 7
  IF ~Global("VariaRescue","GLOBAL",1)~ THEN GOTO 8
END
...
IF ~~ THEN BEGIN 8
  ...
  IF ~~ THEN DO ~SetGlobal("VariaRescue","GLOBAL",0)~ GOTO 12
END

IF ~!AreaCheck("AR1005")
InPartySlot(LastTalkedToBy,0)
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 9
...
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 13
...
IF ~AreaCheck("AR1005")~ THEN BEGIN 15
