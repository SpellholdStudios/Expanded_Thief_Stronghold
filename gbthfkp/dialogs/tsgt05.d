...
IF ~Global("TalkedToJoster","GLOBAL",0)~ THEN BEGIN 0
  SAY #32294 /* ~Hail, <CHARNAME>! It is time! Renal awaits your tribute!~ */
  IF ~~ THEN REPLY #32538 /* ~Time? Time for what? What are you doing here?~ */ DO ~SetGlobal("TalkedToJoster","GLOBAL",1)~ GOTO 1
  IF ~~ THEN REPLY #32819 /* ~Yes, yes, I have been expecting you. No need to get excited.~ */ DO ~SetGlobal("TalkedToJoster","GLOBAL",1)~ GOTO 2
END
...
IF ~~ THEN BEGIN 3
  ...
  IF ~Global("PGQuota","GLOBAL",1) Global("RandomCost","GLOBAL",0)~ THEN GOTO 4
  IF ~Global("PGQuota","GLOBAL",2) Global("RandomCost","GLOBAL",0)~ THEN GOTO 5
  IF ~Global("PGQuota","GLOBAL",3) Global("RandomCost","GLOBAL",0)~ THEN GOTO 6
  IF ~Global("PGQuota","GLOBAL",4) Global("RandomCost","GLOBAL",0)~ THEN GOTO 7
  IF ~Global("PGQuota","GLOBAL",5) Global("RandomCost","GLOBAL",0)~ THEN GOTO 8
  IF ~GlobalGT("PGQuota","GLOBAL",5) RandomNumGT(100,20) RandomNumLT(100,71) Global("RandomCost","GLOBAL",0)~ THEN GOTO 9
  IF ~GlobalGT("PGQuota","GLOBAL",5) RandomNumGT(100,70) RandomNumLT(100,91) Global("RandomCost","GLOBAL",0)~ THEN GOTO 10
  IF ~GlobalGT("PGQuota","GLOBAL",5) RandomNumLT(100,21) Global("RandomCost","GLOBAL",0)~ THEN GOTO 11
  IF ~GlobalGT("PGQuota","GLOBAL",5) RandomNumGT(100,90) Global("RandomCost","GLOBAL",0)~ THEN GOTO 12
  IF ~Global("RandomCost","GLOBAL",1)~ THEN GOTO 9
  IF ~Global("RandomCost","GLOBAL",2)~ THEN GOTO 10
  IF ~Global("RandomCost","GLOBAL",3)~ THEN GOTO 11
  IF ~Global("RandomCost","GLOBAL",4)~ THEN GOTO 12
END
...
IF ~~ THEN BEGIN 4
  ...
  IF ~PartyGoldGT(499)~ THEN REPLY #32831 /* ~I will pay. It is my duty and I do so gladly.~ */ DO ~TakePartyGold(500)~ GOTO 13
...
IF ~~ THEN BEGIN 5
  ...
  IF ~PartyGoldGT(499)~ THEN REPLY #32833 /* ~I will pay. It is my duty and I do so gladly.~ */ DO ~TakePartyGold(500)~ GOTO 13
...
IF ~~ THEN BEGIN 6
  ...
  IF ~PartyGoldGT(999)~ THEN REPLY #32835 /* ~That is quite a lot, but I will not shirk my duty. I will pay.~ */ DO ~TakePartyGold(1000)~ GOTO 13
...
IF ~~ THEN BEGIN 7
  ...
  IF ~PartyGoldGT(999)~ THEN REPLY #32837 /* ~That is quite a lot, but I will not shirk my duty. I will pay.~ */ DO ~TakePartyGold(1000)~ GOTO 13
...
IF ~~ THEN BEGIN 8
  ...
  IF ~PartyGoldGT(349)~ THEN REPLY #32839 /* ~A welcome break. I will gladly pay this small amount.~ */ DO ~TakePartyGold(350)~ GOTO 13
...
IF ~~ THEN BEGIN 9
  ...
  IF ~PartyGoldGT(499)~ THEN REPLY #32841 /* ~It is a duty that I gladly perform. I will pay.~ */ DO ~TakePartyGold(500) SetGlobal("RandomCost","GLOBAL",0)~ GOTO 13
  IF ~~ THEN REPLY #32842 /* ~I cannot pay just yet. Can you wait until I am able?~ */ DO ~SetGlobal("RandomCost","GLOBAL",1)~ GOTO 14
END

IF ~~ THEN BEGIN 10
  SAY #32828 /* ~This time I am called to relieve you of 900 gold as quota. Renal will make good use of your tribute.~ */
  IF ~PartyGoldGT(899)~ THEN REPLY #32843 /* ~A hard payment to swallow, but I will pay it nonetheless.~ */ DO ~TakePartyGold(900) SetGlobal("RandomCost","GLOBAL",0)~ GOTO 13
  IF ~~ THEN REPLY #32844 /* ~I cannot pay just yet. Can you wait until I am able?~ */ DO ~SetGlobal("RandomCost","GLOBAL",2)~ GOTO 14
END

IF ~~ THEN BEGIN 11
  SAY #32829 /* ~300 gold is all that is asked this week. A mere pittance from a successful guild such as yourselves.~ */
  IF ~PartyGoldGT(299)
~ THEN REPLY #32845 /* ~It is a small amout to pay to support the greater guild as a whole.~ */ DO ~TakePartyGold(300) SetGlobal("RandomCost","GLOBAL",0)~ GOTO 13
  IF ~~ THEN REPLY #32846 /* ~I cannot pay just yet. Can you wait until I am able?~ */ DO ~SetGlobal("RandomCost","GLOBAL",3)~ GOTO 14
END
...
IF ~~ THEN BEGIN 12
  ...
  IF ~PartyGoldGT(999)~ THEN REPLY #32847 /* ~That is quite a lot, but I will pay it cheerfully. ~ */ DO ~TakePartyGold(1000) SetGlobal("RandomCost","GLOBAL",0)~ GOTO 13
  IF ~~ THEN REPLY #32848 /* ~I cannot pay just yet. Can you wait until I am able?~ */ DO ~SetGlobal("RandomCost","GLOBAL",4)~ GOTO 14
END

IF ~~ THEN BEGIN 13
  SAY #32849 /* ~A pleasure doing business with you. Renal will be most pleased with your performance. I wish you well. ~ */
  IF ~~ THEN DO ~IncrementGlobal("PGQuota","GLOBAL",1) SetGlobal("JosterLeave","GLOBAL",1) EscapeArea()
EraseJournalEntry(55541)~ SOLVED_JOURNAL #55540 /* ~Thieves' Guild Stronghold: paying my dues.
...
IF ~~ THEN BEGIN 14
  ...
  = #32851 /* ~Be aware that this will not delay my next visit at all. I return every 5 days. If you wait until the 5th day to pay, I will still return the next. It is to your benefit to pay me quick.~ */
...
IF ~~ THEN BEGIN 17
  ...
  IF ~~ THEN DO ~EraseJournalEntry(55540)~ UNSOLVED_JOURNAL #55541 /* ~Thieves' Guild Stronghold: payment must come.
