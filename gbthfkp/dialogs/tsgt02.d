...
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 0
...
InPartySlot(LastTalkedToBy,0)
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 1
  ...
  IF ~Global("MilphThief","GLOBAL",1) Global("MilphRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToGoshan","AR0322",1)~ GOTO 2
  IF ~Global("MilphThief","GLOBAL",2) Global("MilphRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToGoshan","AR0322",1)~ GOTO 3
  IF ~Global("MilphThief","GLOBAL",3) Global("MilphRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToGoshan","AR0322",1)~ GOTO 4
  IF ~Global("MilphThief","GLOBAL",4) Global("MilphRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToGoshan","AR0322",1)~ GOTO 5
  IF ~Global("MilphThief","GLOBAL",0) Global("MilphRescue","GLOBAL",0)~ THEN DO ~SetGlobal("TalkedToGoshan","AR0322",1)~ GOTO 6
  IF ~Global("MilphRescue","GLOBAL",1)~ THEN DO ~SetGlobal("TalkedToGoshan","AR0322",1)~ GOTO 7
END
...
IF ~~ THEN BEGIN 7
  ...
  IF ~~ THEN DO ~SetGlobal("MilphRescue","GLOBAL",0)~ GOTO 13
END

IF ~!AreaCheck("AR1005")
InPartySlot(LastTalkedToBy,0)
Global("PGFailed","GLOBAL",0)~ THEN BEGIN 8
...
IF ~~ THEN BEGIN 9
  ...
  IF ~Global("MilphThief","GLOBAL",1) Global("MilphRescue","GLOBAL",0)~ THEN GOTO 2
  IF ~Global("MilphThief","GLOBAL",2) Global("MilphRescue","GLOBAL",0)~ THEN GOTO 3
  IF ~Global("MilphThief","GLOBAL",3) Global("MilphRescue","GLOBAL",0)~ THEN GOTO 4
  IF ~Global("MilphThief","GLOBAL",4) Global("MilphRescue","GLOBAL",0)~ THEN GOTO 5
  IF ~Global("MilphThief","GLOBAL",0) Global("MilphRescue","GLOBAL",0)~ THEN GOTO 6
  IF ~Global("MilphRescue","GLOBAL",1)~ THEN GOTO 7
END
