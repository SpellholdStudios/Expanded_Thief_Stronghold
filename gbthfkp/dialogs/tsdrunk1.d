...
IF ~Gender(LastTalkedToBy,MALE) RandomNum(5,1)~ THEN BEGIN 0
...
IF ~Gender(LastTalkedToBy,MALE) RandomNum(5,2)~ THEN BEGIN 1
...
IF ~Gender(LastTalkedToBy,MALE) RandomNum(5,3)~ THEN BEGIN 2
...
IF ~Gender(LastTalkedToBy,FEMALE) RandomNum(5,3)~ THEN BEGIN 7
...
IF ~Gender(LastTalkedToBy,FEMALE) RandomNum(5,4)~ THEN BEGIN 8
  SAY #44389 /* ~How about I buy ye an ale, darlin'?  (hic)~ */
  IF ~~ THEN EXIT
END

IF ~Gender(LastTalkedToBy,FEMALE) RandomNum(5,5)~ THEN BEGIN 8
