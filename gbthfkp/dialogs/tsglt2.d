...
IF ~!InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 0
...
!Global("PGFailed","GLOBAL",1)~ THEN BEGIN 1
...
IF ~~ THEN BEGIN 2 // from: 1.1 1.0
  ...
  IF ~~ THEN DO ~CreateCreature("TSAma1",[450.425],10)~ EXIT
END

IF ~!Global("PGFailed","GLOBAL",1)
OR(2)
GlobalGT("LathanPlot","GLOBAL",7)
GlobalTimerNotExpired("KretorTimer","LOCALS")~ THEN BEGIN 4
...
IF ~~ THEN BEGIN 7
  ...
  IF ~~ THEN DO ~SetGlobal("LathanPlot","GLOBAL",1)~ UNSOLVED_JOURNAL #55522 /* ~Thieves' Guild Stronghold: A meeting with Ama.
...
IF ~Global("LathanPlot","GLOBAL",1)~ THEN BEGIN 8
...
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 9
  ...
  IF ~~ THEN DO ~SetGlobal("AmaTalk","LOCALS",1) SetGlobalTimer("KretorTimer","LOCALS",ONE_DAY)~ GOTO 10
END
...
!Dead("Kretor")
!Global("KretorThief","GLOBAL",5)~ THEN BEGIN 11
...
EscapeArea()~ JOURNAL #55526 /* ~Thieves' Guild Stronghold: Harsh judgement.
...
IF ~~ THEN BEGIN 20
  ...
  = #34806 /* ~The first is Darronal Gwin II, a spoiled child of a noble family. I think he works for Kretor out of bordom, or perhaps he's slumming. He doesn't really need the money, but he is pretty obstinant.~ */
...
IF ~~ THEN BEGIN 30
  ...
  IF ~~ THEN REPLY #34852 /* ~I don't know. Kill that Darronal Gwin. He's probably the one.~ */ DO ~SetGlobal("KretorPay","GLOBAL",2) SetGlobal("LathanPlot","GLOBAL",5)~ GOTO 31
  IF ~~ THEN REPLY #34853 /* ~Kill Thrand. I'm sure the sob-story of his family is a fake anyway.~ */ DO ~SetGlobal("KretorPay","GLOBAL",1) SetGlobal("LathanPlot","GLOBAL",6)~ GOTO 31
  IF ~~ THEN REPLY #34854 /* ~Oh, just kill that Shadel person. She's probably the thief.~ */ DO ~SetGlobal("KretorPay","GLOBAL",1) SetGlobal("LathanPlot","GLOBAL",6)~ GOTO 31
  IF ~~ THEN REPLY #34855 /* ~Kill that pompous Blood Nightmaster. That wannabe is probably the thief.~ */ DO ~SetGlobal("KretorPay","GLOBAL",1) SetGlobal("LathanPlot","GLOBAL",6)~ GOTO 31
...
EscapeArea()~ UNSOLVED_JOURNAL #55532 /* ~Thieves' Guild Stronghold: Thieves among thieves.
...
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 32
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",9) SetGlobal("LathanPlot","GLOBAL",8)~ GOTO 37
END

IF ~Global("LathanPlot","GLOBAL",4)
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 33
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",9) SetGlobal("LathanPlot","GLOBAL",8)~ GOTO 39
END

IF ~Global("LathanPlot","GLOBAL",5)
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 34
...
SetGlobal("LathanPlot","GLOBAL",8)~ JOURNAL #55533 /* ~Thieves' Guild Stronghold: Thieves among thieves.
...
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 35
  ...
  IF ~~ THEN DO ~SetGlobal("KretorThief","GLOBAL",9) SetGlobal("LathanPlot","GLOBAL",8)~ GOTO 42
END

IF ~Global("LathanPlot","GLOBAL",7)
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 36
  ...
  IF ~~ THEN DO ~SetGlobal("LathanPlot","GLOBAL",8)~ GOTO 43
END
...
EraseJournalEntry(55530)
EraseJournalEntry(55531)
EraseJournalEntry(55532)~ JOURNAL #55536 /* ~Thieves' Guild Stronghold: Thieves among thieves.
...
EraseJournalEntry(55530)
EraseJournalEntry(55531)
EraseJournalEntry(55532)~ JOURNAL #55537 /* ~Thieves' Guild Stronghold: Thieves among thieves.
...
EraseJournalEntry(55530)
EraseJournalEntry(55531)
EraseJournalEntry(55532)~ JOURNAL #55535 /* ~Thieves' Guild Stronghold: Thieves among thieves.
...
EraseJournalEntry(55530)
EraseJournalEntry(55531)
EraseJournalEntry(55532)~ JOURNAL #55534 /* ~Thieves' Guild Stronghold: Thieves among thieves.
...
IF ~Global("PGFailed","GLOBAL",1)
InPartySlot(LastTalkedToBy,0)~ THEN BEGIN 47
  ...
  IF ~~ THEN DO ~EraseJournalEntry(55542)~ UNSOLVED_JOURNAL #55538 /* ~Thieves' Guild Stronghold: the guild has failed.
